...
String whatPet= JOptionPane.showInputDialog("What pet do you want?");
		// 7. REPEAT steps 3 - 6 enough times to make your pet happy!
			...
			int task = JOptionPane.showOptionDialog(null, "What do yu want 2 do 2 make your "+whatPet+" happy?", "Things to do for yor "+whatPet, 0, JOptionPane.INFORMATION_MESSAGE, null,
